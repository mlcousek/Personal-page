const BLOG_POSTS = [
  {
    ...
    title: {
      en: 'BUT82: 19th Overall, Top 20, and a Lesson About Starting Guns',
      cs: 'BUT82: 19. místo, top 20 a lekce ze startovního výstřelu',
      es: 'BUT82: 19.º general, top 20 y una lección sobre la salida'
    },
    excerpt: {
...
<p>I filmed video for the entire race and had no idea what place I was in. I ran purely on feel, with nobody telling me where I stood. At the finish line: <strong>19th overall, 8th in category</strong>, in <strong>11:17:22</strong>. Tomáš Fiala beat me across the line by three seconds. New race shoes — HOKA Tecton X3 — held up for all 86 km without a single blister. The target for BUT 2027 is sub-11:00. With an honest start, it's within reach.</p>`,
      cs: `<p>Beskydský Ultra Trail — poprvé na 82km distanci po loňské B7. Závod startuje v Bumbálce v 07:00, obíhá celý beskydský hřeben přes Pustevny, Ostravici, Lysou horu a Bílý Kříž a vrací se do cíle v Bílé. Oficiálně 82 km a 3 222 m převýšení — hodinky ukázaly 86 km a 3 658 m. Dlouhý den tak nebo tak.</p>
